...
public class LoginPacketPayload {
    ...
    private void decodeSkinData(Buffer buf) {
        try {
            ...
            if (skinToken.has("SkinData"))
                this.skin = new Skin(skinId, Base64.getDecoder().decode(skinToken.get("SkinData").getAsString()));
    ...
    public String toString()    {
        return "LoginPacketPayload(Username:" + this.username + ",UUID:" + this.clientUUID.toString() + ",SkinSize:" + this.skin.data.length + ")";
    }
}
